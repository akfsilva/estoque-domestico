...
window.del = function(id){
    if(confirm("DELETAR ITEM?")){ items = items.filter(i => i.id !== id); save(); render(); }
};
            ...
            return `
                <div class="item">
                    ...
                    <div class="suggested-box">
                        <span>ESTIMATIVA (${i.persons || 1} PES.): ${suggested} ${i.unit}</span>
                        <button style="width:auto; padding:5px 10px; font-size:10px" onclick="applyMeta(${i.id}, ${suggested})">APLICAR</button>
                    </div>
                    <div class="controls">
                    ...
                    <input type="text" style="font-size:11px; margin-top:5px; border-style:dashed" value="${i.note || ''}" placeholder="NOTAS" onchange="upd(${i.id},'note',this.value)">
